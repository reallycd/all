...
| Hertzbeat | 监控 | 一站式实时监控、预警、通知系统，支持网络、服务器性能、数据库、容器等 | [项目地址](https://github.com/apache/hertzbeat) | [教程地址](https://post.smzdm.com/p/a96zn847/) |  |
| Kener | 监控 | 服务器监控 | [项目地址](https://github.com/rajnandan1/kener) | [教程地址](https://post.smzdm.com/p/a5x7k3n7/) |  |
| Netdata | 监控 | 经典的服务器监控仪表盘 | [项目地址](https://github.com/netdata/netdata) | [教程地址](https://post.smzdm.com/p/ag5z6lv6/) |  |
| Beszel | 监控 | 一套作用于NAS和服务器端的轻量级监控工具 | [项目地址](https://github.com/henrygd/beszel) | [教程地址](https://post.smzdm.com/p/a8p36r0l/) |  |
| Easynode | 运维 | 多功能Linux服务器WEB面板(webSSH&webSFTP) | [项目地址](https://github.com/chaos-zhu/easynode) | [教程地址](https://post.smzdm.com/p/axo487v2/) |  |
| Nging | 服务器管理 | 含ningx、caddy的Web管理面板，功能巨多 | [项目地址](https://github.com/admpub/nging) | [教程地址](https://post.smzdm.com/p/apmmlwg0/) |  | 
|  |
